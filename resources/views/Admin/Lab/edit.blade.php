                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Horizontal Form -->
                            <form action="{{ route('lab.update') }}" method="post" enctype="multipart/form-data">@csrf

                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Lab Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputText" name="lab_name" value="{{$lab->lab_name}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputText" name="city" value="{{$lab->city}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputText" name="pin" value="{{$lab->pin}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputText" name="state" value="{{$lab->state}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputText" name="phone" value="{{$lab->phone}}">
